...
namespace STBuildTool
{
    ...
    public partial class CPPEnvironment
    {
        ...
        public static readonly Dictionary<STBuildTarget, DependencyCache> IncludeDependencyCache = new Dictionary<STBuildTarget, DependencyCache>();

        /** Contains a cache of include dependencies (direct and indirect), one for each target we're building. */
        public static readonly Dictionary<STBuildTarget, FlatCPPIncludeDependencyCache> FlatCPPIncludeDependencyCache = new Dictionary<STBuildTarget, FlatCPPIncludeDependencyCache>();
        ...
        public static List<FileItem> FindAndCacheAllIncludedFiles(STBuildTarget Target, FileItem SourceFile, IUEBuildPlatform BuildPlatform, CPPIncludeInfo CPPIncludeInfo, bool bOnlyCachedDependencies)
        {
            ...
            bool bUseFlatCPPIncludeDependencyCache =
                (BuildConfiguration.bUseExperimentalFastDependencyScan &&
                  (!BuildConfiguration.bUseExperimentalFastBuildIteration || STBuildTool.IsAssemblingBuild));
        ...
        public static bool FindAndCacheAllIncludedFiles(STBuildTarget Target, FileItem CPPFile, IUEBuildPlatform BuildPlatform, CPPIncludeInfo CPPIncludeInfo, ref IncludedFilesSet Result, bool bOnlyCachedDependencies)
        {
        ...
        public static List<DependencyInclude> GetDirectIncludeDependencies(STBuildTarget Target, FileItem CPPFile, IUEBuildPlatform BuildPlatform, bool bOnlyCachedDependencies, out bool HasUObjects)
        {
        ...
        private static void CollectHeaders(FileItem CPPFile, List<DependencyInclude> Result, string FileToRead, string FileContents, string InstalledFolder, int StartIndex, int EndIndex)
        {
            ...
            foreach (Capture C in CC)
            {
                ...
                {
                    bCheckForBackwardSlashes |= Utils.IsFileUnderDirectory(FileToRead, STBuildTool.GetUProjectPath());
                }
