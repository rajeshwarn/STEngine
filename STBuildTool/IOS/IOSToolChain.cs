...
namespace STBuildTool
{
	class IOSToolChain : RemoteToolChain
	{
		...
		{
			RegisterRemoteToolChain(STTargetPlatform.Mac, CPPTargetPlatform.IOS);
		}
		...
		public List<STBuildFramework> RememberedAdditionalFrameworks = new List<STBuildFramework>();
...
// 			}
		...
		public override STTargetPlatform GetPlatform()
		{
			return STTargetPlatform.IOS;
		}
