                        ...
                        if (String.IsNullOrEmpty(JunkEntry) == false)
                        {
                            ...
                            foreach (string Token in Tokens)
                            {
                                ...
                                else if (Token.StartsWith("Platform=", StringComparison.InvariantCultureIgnoreCase) == true)
                                {
                                    ...
                                    {
                                        STTargetPlatform ParsedPlatform = STBuildPlatform.ConvertStringToPlatform(InnerTokens[1]);
                                        ...
                                        {
                                            if (STBuildPlatform.GetBuildPlatform(ParsedPlatform, bInAllowFailure: true) != null)
                                            {
