...
namespace STBuildTool
{
    public class UProjectInfo
    {
        ...
        public static void FillProjectInfo()
        {
            ...
            string EngineSourceDirectory = Path.GetFullPath(Path.Combine(RootDirectory, "STEngine", "Source"));
            ...
            if (STBuildTool.CommandLineContains("-dumpprojectinfo"))
            {
        ...
        /// <param name="InProjectName">Name of the project of interest</param>
        /// <returns>The project filename, empty string if not found</returns>
        public static List<string> GetEnabledPlugins(string ProjectFileName, List<string> DefaultEnabledPlugins, STTargetPlatform Platform)
        {
