...
namespace STBuildTool
{
    public class PluginInfo
    {
        ...
        public struct PluginModuleInfo
        {
            ...
            public List<STTargetPlatform> Platforms;
        }
    ...
    class PluginReferenceDescriptor
    {
        ...
        public List<STTargetPlatform> WhitelistPlatforms = new List<STTargetPlatform>();
        public List<STTargetPlatform> BlacklistPlatforms = new List<STTargetPlatform>();
        ...
        static void TryParsePlatformList(Dictionary<string, object> Dictionary, string FieldName, List<STTargetPlatform> Platforms)
        {
            object ArrayObject;
    ...
    public class Plugins
    {
        ...
        private static void ConvertPlatformArrayToList(Array PlatformNameList, ref List<STTargetPlatform> Platforms, string ModuleFilename)
        {
            ...
            foreach (string PlatformName in PlatformNameList)
            {
                ...
                foreach (STTargetPlatform PossiblePlatform in Enum.GetValues(typeof(STTargetPlatform)))
                {
