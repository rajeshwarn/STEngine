...
namespace STBuildTool
{
    ...
    public partial class CPPEnvironment
    {
        ...
        public static List<FileItem> FindAndCacheAllIncludedFiles(STBuildTarget Target, FileItem SourceFile, ISTBuildPlatform BuildPlatform, CPPIncludeInfo CPPIncludeInfo, bool bOnlyCachedDependencies)
        {
        ...
        public static bool FindAndCacheAllIncludedFiles(STBuildTarget Target, FileItem CPPFile, ISTBuildPlatform BuildPlatform, CPPIncludeInfo CPPIncludeInfo, ref IncludedFilesSet Result, bool bOnlyCachedDependencies)
        {
        ...
        public static List<DependencyInclude> GetDirectIncludeDependencies(STBuildTarget Target, FileItem CPPFile, ISTBuildPlatform BuildPlatform, bool bOnlyCachedDependencies, out bool HasUObjects)
        {
