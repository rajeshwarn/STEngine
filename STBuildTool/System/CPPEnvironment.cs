...
namespace STBuildTool
{
    ...
    public class CPPEnvironmentConfiguration : NativeBuildEnvironmentConfiguration
    {
        ...
        /** True if the precompiled header needs to be "force included" by the compiler.  This is usually used with
            the "Shared PCH" feature of STBuildTool.  Note that certain platform toolchains *always* force
        ...
        public List<STBuildFramework> AdditionalFrameworks = new List<STBuildFramework>();
    ...
    public class SharedPCHHeaderInfo
    {
        ...
        public STBuildModuleCPP Module;

        /// All dependent modules
        public Dictionary<string, STBuildModule> Dependencies;
    }
    ...
    public partial class CPPEnvironment
    {
         ...
         */
        public CPPOutput CompileFiles(STBuildTarget Target, List<FileItem> CPPFiles, string ModuleName)
        {
            return STToolChain.GetPlatformToolChain(Config.Target.Platform).CompileCPPFiles(Target, this, CPPFiles, ModuleName);
        }
         ...
         */
        public CPPOutput CompileRCFiles(STBuildTarget Target, List<FileItem> RCFiles)
        {
            return STToolChain.GetPlatformToolChain(Config.Target.Platform).CompileRCFiles(Target, this, RCFiles);
        }
        ...
        {
            return STBuildPlatform.GetBuildPlatformForCPPTargetPlatform(Config.Target.Platform).ShouldUsePCHFiles(Config.Target.Platform, Config.Target.Configuration);
        }
