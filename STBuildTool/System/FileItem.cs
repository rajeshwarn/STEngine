...
namespace STBuildTool
{
    ...
    public class FileItem : ISerializable
    {
        ...
        public static FileItem GetRemoteItemByPath(string AbsoluteRemotePath, STTargetPlatform Platform)
        {
        ...
        protected FileItem(string InAbsolutePath, bool InIsRemoteFile, STTargetPlatform Platform)
        {
            ...
            if (bIsRemoteFile)
            {
                if (Platform == STTargetPlatform.IOS || Platform == STTargetPlatform.Mac)
                {
                    lock (DelayedRemoteLookupFiles)
                    {
                        DelayedRemoteLookupFiles.Add(this);
