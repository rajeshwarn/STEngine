...
namespace STBuildTool
{
    ...
    public static class STBuildModuleTypeExtensions
    {
        public static bool IsEngineModule(this STBuildModuleType ModuleType)
        {
            return ModuleType != STBuildModuleType.Game;
        }
    }

    /** A unit of code compilation and linking. */
    public abstract class STBuildModule
    {
        ...
        public static STBuildModuleType GetPluginModuleType(string ModuleName)
        {
            STBuildModuleType ModuleType = STBuildModuleType.Unknown;
        ...
        public readonly STBuildTarget Target;
        ...
        protected readonly HashSet<STBuildFramework> PublicAdditionalFrameworks;
        protected readonly HashSet<string> PublicAdditionalShadowFiles;
        protected readonly HashSet<STBuildBundleResource> PublicAdditionalBundleResources;
        ...
        public virtual void AddAdditionalBundleResource(STBuildBundleResource Resource, bool bCheckForDuplicates = true)
        {
            if (bCheckForDuplicates == true)
            {
        ...
        public virtual string FixupOutputPath(string InOutputPath)
        {
            ...
            if ((OutputDirectory.Length != 0) && (STBuildTool.BuildingRocket() == false))
            {
        ...
        {
            var VisitedModules = new Dictionary<STBuildModule, bool>();

            if (this.Type == STBuildModuleType.Game)
            {
         ...
         */
        public virtual void GetAllDependencyModules(ref Dictionary<string, STBuildModule> ReferencedModules, ref List<STBuildModule> OrderedModules, bool bIncludeDynamicallyLoaded, bool bForceCircular, bool bOnlyDirectDependencies)
        {
        }
    ...
    class STBuildExternalModule : STBuildModule
    {
    ...
    public class STBuildModuleCPP : STBuildModule
    {
        ...
        private SHTModuleInfo CachedModuleUHTInfo = null;
        ...
        /// <returns>
        public SHTModuleInfo GetUHTModuleInfo()
        {
            ...
            CachedModuleUHTInfo = new SHTModuleInfo
            {
        ...
        public override void GetAllDependencyModules(ref Dictionary<string, STBuildModule> ReferencedModules, ref List<STBuildModule> OrderedModules, bool bIncludeDynamicallyLoaded, bool bForceCircular, bool bOnlyDirectDependencies)
        {
    ...
    class STBuildModuleCPPCLR : STBuildModuleCPP
    {
    ...
    public class STBuildFramework
    {
        public STBuildFramework(string InFrameworkName)
        {
            FrameworkName = InFrameworkName;
        }

        public STBuildFramework(string InFrameworkName, string InFrameworkZipPath)
        {
            FrameworkName = InFrameworkName;
            FrameworkZipPath = InFrameworkZipPath;
        }

        public STBuildFramework(string InFrameworkName, string InFrameworkZipPath, string InCopyBundledAssets)
        {
            FrameworkName = InFrameworkName;
            FrameworkZipPath = InFrameworkZipPath;
        ...
        public STBuildModule OwningModule = null;
        public string FrameworkName = null;
        public string FrameworkZipPath = null;
        public string CopyBundledAssets = null;
    }

    public class STBuildBundleResource
    {
        public STBuildBundleResource(string InResourcePath, string InBundleContentsSubdir = "Resources")
        {
