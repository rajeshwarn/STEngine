...
{
    [Serializable]
    public class STBuildServer : STBuildTarget
    {
        public STBuildServer(
            string InGameName,
            ...
            : base(
                InAppName: STBuildTarget.GetBinaryBaseName(InGameName, InRulesObject, InPlatform, InConfiguration, "Server"),
