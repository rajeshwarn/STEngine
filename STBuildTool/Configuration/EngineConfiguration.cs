...
namespace STBuildTool
{
    ...
    public class ConfigCacheIni
    {
        ...
        {
            Init(STTargetPlatform.Unknown, BaseIniName, ProjectDirectory, EngineDirectory);
        }
        ...
        /// <param name="Platform">Target platform</param>
        /// <param name="BaseIniName">Ini name (Engine, Editor, etc)</param>
        public ConfigCacheIni(STTargetPlatform Platform, string BaseIniName, string ProjectDirectory, string EngineDirectory = null)
        {
            Init(Platform, BaseIniName, ProjectDirectory, EngineDirectory);
        }

        private void Init(STTargetPlatform Platform, string BaseIniName, string ProjectDirectory, string EngineDirectory)
        {
        ...
        /// </summary>
        private static IEnumerable<string> EnumerateCrossPlatformIniFileNames(string ProjectDirectory, string EngineDirectory, STTargetPlatform Platform, string BaseIniName)
        {
        ...
        /// </summary>
        private static string GetIniPlatformName(STTargetPlatform TargetPlatform)
        {
            if (TargetPlatform == STTargetPlatform.Win32 || TargetPlatform == STTargetPlatform.Win64)
            {
                return "Windows";
            }
            else
            {
                return Enum.GetName(typeof(STTargetPlatform), TargetPlatform);
            }
        }
    }
}
