...
{
    public class STBuildConfiguration
    {
        ...
        public static void PostReset()
        {
            ...
            bCompileSteamOSS = bCompileSteamOSS
               && Directory.Exists(STBuildConfiguration.UEThirdPartySourceDirectory + "Steamworks/" + SteamVersion) == true;
            ...
            bCompileSimplygon = bCompileSimplygon
                && Directory.Exists(STBuildConfiguration.UEThirdPartySourceDirectory + "NotForLicensees") == true
                && Directory.Exists(STBuildConfiguration.UEThirdPartySourceDirectory + "NotForLicensees/Simplygon") == true
            ...
            if (STBuildTool.CommandLineContains(@"UnrealCodeAnalyzer") || STBuildTool.CommandLineContains(@"UnrealHeaderTool"))
            {
