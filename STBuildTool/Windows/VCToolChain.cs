...
{
    public class VCToolChain : STToolChain
    {
        public override void RegisterToolChain()
        {
            ...
            STToolChain.RegisterPlatformToolChain(CPPTargetPlatform.Win64, this);
            Log.TraceVerbose("        Registered for {0}", CPPTargetPlatform.Win32.ToString());
            STToolChain.RegisterPlatformToolChain(CPPTargetPlatform.Win32, this);
        }
