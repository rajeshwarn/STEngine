...
namespace STBuildTool
{
    ...
    public class WindowsPlatform : STBuildPlatform
    {
        /// Property caching.
        ...
        /**
         *	Register the platform with the STBuildPlatform class
         */
        protected override void RegisterBuildPlatformInternal()
        {
            // Register this build platform for both Win64 and Win32
            Log.TraceVerbose("        Registering for {0}", STTargetPlatform.Win64.ToString());
            STBuildPlatform.RegisterBuildPlatform(STTargetPlatform.Win64, this);
            STBuildPlatform.RegisterPlatformWithGroup(STTargetPlatform.Win64, STPlatformGroup.Windows);
            STBuildPlatform.RegisterPlatformWithGroup(STTargetPlatform.Win64, STPlatformGroup.Microsoft);

            Log.TraceVerbose("        Registering for {0}", STTargetPlatform.Win32.ToString());
            STBuildPlatform.RegisterBuildPlatform(STTargetPlatform.Win32, this);
            STBuildPlatform.RegisterPlatformWithGroup(STTargetPlatform.Win32, STPlatformGroup.Windows);
            STBuildPlatform.RegisterPlatformWithGroup(STTargetPlatform.Win32, STPlatformGroup.Microsoft);
        }
        ...
        /**
         *	Validate the STBuildConfiguration for this platform
         *	This is called BEFORE calling STBuildConfiguration to allow setting 
         *	various fields used in that function such as CompileLeanAndMean...
         */
        public override void ValidateSTBuildConfiguration()
        {
            STBuildConfiguration.bCompileICU = true;
        }
         ...
         *	@param	InBuildTarget		The target being built
         */
        public override void SetUpConfigurationEnvironment(STBuildTarget InBuildTarget)
        {
